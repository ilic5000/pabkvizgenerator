...
for file in videoFiles:
    ...
    # do something
    try:
        os.system("python slagalica-single-video.py -srcdir \"%s\" -file \"%s\" -o \"%s\" -lang \"%s\" -csv \"%s\" -d %s" %(directoryWithVideoFiles, file, directoryOutput, language, csvFileName, createDebugData))
